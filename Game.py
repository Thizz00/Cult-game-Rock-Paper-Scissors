...
"}")
        ...
        self.pushButton_6.clicked.connect(lambda:self.label.setStyleSheet("image: url(rock.png);"))
...
"}")
        ...
        self.pushButton_7.clicked.connect(lambda:self.label.setStyleSheet("image: url(new-document.png);"))
...
"color:white;\n"
"background-color:#e6b071;\n"
"image: url(cut-with-scissors.png);\n"
"}\n"
"QPushButton:hover\n"
"{\n"
"background-color: rgb(255, 170, 127);\n"
...
"}")
        ...
        self.pushButton_8.clicked.connect(lambda:self.label.setStyleSheet("image: url(cut-with-scissors.png);"))
    ...
    def bot(self):
            import random
            list1=["image: url(rock.png);","image: url(new-document.png);","image: url(cut-with-scissors.png);"]
    ...
    def answer(self):
                if (self.label.styleSheet() =="image: url(rock.png);" and self.label_2.styleSheet() == "image: url(rock.png);") or (self.label.styleSheet() =="image: url(new-document.png);" and self.label_2.styleSheet() =="image: url(new-document.png);") or (self.label.styleSheet() =="image: url(cut-with-scissors.png);" and self.label_2.styleSheet() == "image: url(cut-with-scissors.png);"):
                ...
                elif (self.label.styleSheet() =="image: url(rock.png);" and self.label_2.styleSheet() =="image: url(cut-with-scissors.png);") or (self.label.styleSheet() =="image: url(new-document.png);" and self.label_2.styleSheet() == "image: url(rock.png);") or (self.label.styleSheet() == "image: url(cut-with-scissors.png);" and self.label_2.styleSheet() == "image: url(new-document.png);"):
